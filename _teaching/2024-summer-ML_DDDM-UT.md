...
collection: teaching
type: "Workshop"
permalink: /teaching/2024-summer-ML_DDDM-UT
...
- [Syllabus.pdf](/files/teaching/2024-summer-ML_DDDM-UT/syllabus.pdf)
...
<ul>
  {% for file in site.static_files %}
    {% if file.path contains '/files/teaching/2024-summer-ML_DDDM-UT/Slides' %}
...
<ul>
  {% assign folder_pages = site.pages | where_exp: "item", "item.path contains 'files/teaching/2024-summer-ML_DDDM-UT/Slides/'" %}
...
<ul>
  {% for file in site.static_files %}
    {% if file.path contains '/files/teaching/2024-summer-ML_DDDM-UT/Tutorials' and file.extname == '.html' %}
      <li><a href="{{ file.path | relative_url }}">{{ file.name }}</a></li>
    {% endif %}
  {% endfor %}
</ul>
...
<ul>
  {% assign folder_pages = site.pages | where_exp: "item", "item.path contains 'files/teaching/2024-summer-ML_DDDM-UT/Tutorials/'" %}
  {% for p in folder_pages %}
    {% if p.path contains '.Rmd' %}
      <li>
        <a href="{{ p.url | relative_url }}">
